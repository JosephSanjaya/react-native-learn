...
import { IBackgroundSyncService } from '../../services/IBackgroundSyncService.ts';
import { IPermissionService } from '../../services/IPermissionService.ts';
import { INotificationService } from '../../services/INotificationService.ts';
import { IFCMService } from '../../services/IFCMService.ts';
import { IBluetoothService } from '../../../features/bluetooth/services/IBluetoothService.ts';
import { IBluetoothDeviceRepository } from '../../../features/bluetooth/data/IBluetoothDeviceRepository.ts';
import { ICameraService } from '../../../features/camera/services/ICameraService.ts';
import { IBarcodeRepository } from '../../../features/camera/data/IBarcodeRepository.ts';
...
import { BluetoothDeviceRepository } from '../../../features/bluetooth/data/BluetoothDeviceRepository.ts';
import { BarcodeRepository } from '../../../features/camera/data/BarcodeRepository.ts';
...
import { BluetoothService } from '../../../features/bluetooth/services/BluetoothService.ts';
import { CameraService } from '../../../features/camera/services/CameraService.ts';
import { BluetoothUseCase } from '../../../features/bluetooth/domain/BluetoothUseCase.ts';
import { CameraUseCase } from '../../../features/camera/domain/CameraUseCase.ts';
