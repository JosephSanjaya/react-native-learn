import { ICameraService, BarcodeResult, CameraPermissionStatus } from '../services/ICameraService.ts';
import { IBarcodeRepository, BarcodeData } from '../data/IBarcodeRepository.ts';
