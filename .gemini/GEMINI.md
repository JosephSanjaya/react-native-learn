...
* Use the official **React Native Material Design libraries** (e.g., `react-native-paper`, `react-native-vector-icons`).
...
* All Material components must be **accessible by default**.
* Provide **labels, roles, and testIDs** for automated testing and accessibility support.
